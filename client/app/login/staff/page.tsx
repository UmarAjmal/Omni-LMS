      ...
      <Card className={`w-full max-w-md shadow-xl border-0 transition-opacity duration-500 ${mounted ? "opacity-100" : "opacity-0"}`}>
        <CardContent className="p-8 md:p-10">
          ...
          <div className="mb-10 text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-xl mb-6 bg-gray-900 text-white shadow-sm">
              <span className="material-symbols-outlined text-3xl" style={{ fontVariationSettings: "'FILL' 1" }}>admin_panel_settings</span>
            </div>
            <h1 className="text-2xl font-bold text-gray-900 mb-2 tracking-tight">Staff &amp; Admin Portal</h1>
            <p className="text-gray-500 text-sm">Sign in with your employee credentials.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            <div>
              <Label htmlFor="staff-email">Employee ID or Email</Label>
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <Label htmlFor="staff-password" className="mb-0">Password</Label>
